...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        holder.title.setText(product.getNombre());
        holder.description.setText(product.getNombre());
        holder.price.setText(String.valueOf(product.getPrecio()));
        holder.amount.setText(String.valueOf(product.getCantidad()));
